...
<section class="checkout-page bg-dark-light">
    <div class="auto-container">
            ...
            <div class="col-lg-6">
                ...
                <div class="checkout__payment">
                    <div class="checkout__payment__item checkout__payment__item--active">
                        <h3 class="checkout__payment__title">Credit or Debit Card</h3>
                        ...
                        <div class="text-right d-flex justify-content-end">
                                <form action="{{route('billing_process')}}" method="POST" id="payment-form">
                                    @csrf
                            <button  class="theme-btn btn-style-one pay_now_button" >
                                <i class="btn-curve"></i>
                                <span class="btn-title">Place your order</span>
                            </button>
                        </form>
                        </div>
